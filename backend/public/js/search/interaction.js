...
(function() {
    ...
    const showToast = (message, type = 'success') => {
        ...
        toast.className = `${bgColor} text-white px-4 py-3 rounded-xl shadow-xl flex items-center gap-3 transform transition duration-300 translate-y-10 opacity-0 pointer-events-auto min-w-[200px]`;

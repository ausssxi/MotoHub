...
final class RankingService
{
    ...
    {
        return Cache::remember('ranking_positions_all_v6', 604800, function () {
    ...
    {
        return Cache::remember("ranking_positions_cat_v6_{$categoryId}", 604800, function () use ($categoryId) {
            $lms = Carbon::now()->subMonth()->startOfMonth();
            $lme = Carbon::now()->subMonth()->endOfMonth();
    ...
    {
        return Cache::remember("model_ranking_stats_v6_{$bikeModelId}", 604800, function () use ($bikeModelId, $categoryId) {
            $lms = Carbon::now()->subMonth()->startOfMonth();
            $lme = Carbon::now()->subMonth()->endOfMonth();

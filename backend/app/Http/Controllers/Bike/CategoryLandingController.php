...
final class CategoryLandingController extends Controller
{
    ...
    private const TYPE_MAP = [
        ...
        'scooter' => ['ids' => [3, 18, 19], 'label' => 'スクーター', 'description' => 'AT操作で手軽に乗れるスクーター。メットインスペースや足元フラットの利便性が魅力。通勤・通学の日常使いから、ビッグスクーターでのロングツーリングまで幅広く対応します。'],
        'scooter-50' => ['ids' => [3], 'label' => '原付スクーター', 'description' => '排気量50cc以下の原付一種スクーター。原付免許のほか、普通自動車免許でも運転できます。法定速度は30km/hで、交差点によっては二段階右折が必要です。通勤・通学や買い物など、近距離の移動に使われます。'],
        'scooter-125' => ['ids' => [19], 'label' => 'スクーター/51〜125cc', 'description' => '排気量51〜125ccのスクーター。運転には小型限定普通二輪免許以上が必要です。30km/h制限と二段階右折がなく、車の流れに乗って走れます。高速道路と自動車専用道路は走行できません。'],
        'scooter-126' => ['ids' => [18], 'label' => 'スクーター/126cc以上', 'description' => '排気量126cc以上のスクーター。運転には普通自動二輪免許以上（400ccを超える場合は大型自動二輪免許）が必要です。高速道路や自動車専用道路を走行でき、長距離の移動にも使えます。'],

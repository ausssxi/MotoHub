...
final class CategoryLandingController extends Controller
{
    private const CC_MAP = [
        '50' => ['min' => 0, 'max' => 50, 'label' => '50cc以下', 'description' => '原付免許で乗れる手軽なバイク。通勤・通学の足として最適で、維持費も最も安いクラスです。燃費性能に優れ、駐輪場にも停めやすいコンパクトさが魅力。'],
        '125' => ['min' => 51, 'max' => 125, 'label' => '51〜125cc', 'description' => '小型二輪免許で乗れる原付二種クラス。二段階右折不要・二人乗り可能で、通勤から軽いツーリングまで幅広く活躍。ファミリーバイク特約で保険料も抑えられます。'],
        '250' => ['min' => 126, 'max' => 250, 'label' => '126〜250cc', 'description' => '車検不要で維持費が安く、高速道路も走行可能。ツーリングから街乗りまでバランスの良いクラスで、初めての中型バイクとしても人気です。'],
        '400' => ['min' => 251, 'max' => 400, 'label' => '251〜400cc', 'description' => '普通二輪免許で乗れる最大排気量クラス。十分なパワーと扱いやすさを両立し、長距離ツーリングも快適。教習所で乗るバイクのクラスでもあり、親しみやすい排気量帯です。'],
        '750' => ['min' => 401, 'max' => 750, 'label' => '401〜750cc', 'description' => '大型二輪免許が必要なミドルクラス。余裕のあるパワーで高速巡航が楽になり、ワインディングも存分に楽しめます。大型の中では比較的軽量で取り回しやすいモデルが多いのが特徴。'],
        'over750' => ['min' => 751, 'max' => 99999, 'label' => '751cc以上', 'description' => '圧倒的なパワーとトルクを誇るリッタークラス。長距離ツーリングの快適性、ワインディングでのダイナミックな走り、所有欲を満たすプレミアム感が魅力のフラッグシップ排気量帯です。'],
    ];
    ...
    {
        $cacheKey = "category_landing:{$mode}:{$slug}";
        ...
        $data = Cache::remember($cacheKey, 3600, function () use ($baseQuery) {
            ...
            $latestListings = (clone $baseQuery)
                ->with(['shop', 'bikeModel.manufacturer', 'tags'])

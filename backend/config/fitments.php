...
return [
    ...
    */
    'oil_general' => [
        ...
        // keyword は用品アフィリ（ProductSearchService）用。排気量サフィックス（例「大型」「250cc」）は
        // Yahoo（ジャンル絞り無し）で「大型品」「250cc対応パーツ」等に誤マッチしジャンクを招くため付けない。
        // 全帯で共通の「バイク エンジンオイル」に収束（実データ検証で両モールとも該当オイルが上位／キャッシュ最大収束）。
        'bands' => [
            ['max' => 125,  'label' => '〜125cc',    'capacity' => '約0.8〜1.2L', 'interval' => '3,000〜5,000km または半年〜1年', 'keyword' => 'バイク エンジンオイル'],
            ['max' => 250,  'label' => '126〜250cc', 'capacity' => '約1.0〜2.0L', 'interval' => '3,000〜5,000km または半年〜1年', 'keyword' => 'バイク エンジンオイル'],
            ['max' => 400,  'label' => '251〜400cc', 'capacity' => '約2.0〜3.0L', 'interval' => '3,000〜5,000km または半年〜1年', 'keyword' => 'バイク エンジンオイル'],
            ['max' => null, 'label' => '401cc〜',    'capacity' => '約3.0〜4.0L', 'interval' => '3,000〜6,000km または1年',       'keyword' => 'バイク エンジンオイル'],
        ],
    ],
];

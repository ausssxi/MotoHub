            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <div class="text-xs font-bold text-gray-500 flex items-center gap-2">
                        ...
                        総走行距離: {{ number_format($myBike->odometer) }} km
                    </div>
                </div>
            </div>

            <div x-data="{ tab: 'fuel' }" class="space-y-6">
                ...
                {{-- 1. 給油記録セクション --}}
                <div x-show="tab === 'fuel'" class="animate-in fade-in slide-in-from-bottom-2">
                    {{-- 入力フォーム --}}
                        ...
                        <form action="{{ route('mybikes.fuel.store', $myBike->id) }}" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="filled_at" value="{{ date('Y-m-d') }}" required 
                                ...
                                <div>
                                    ...
                                    <input type="number" name="odometer" placeholder="例: 12345" required 
                                        class="block w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 outline-none transition-all">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="memo" placeholder="例: 環七のGSで給油" 
                                    class="block w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 outline-none transition-all">
                            </div>

                            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-3 rounded-xl shadow-lg transition-all transform active:scale-95">
                                記録する
                            </button>
                        </form>
                    </div>
                        ...
                        <form action="{{ route('mybikes.maintenance.store', $myBike->id) }}" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="maintained_at" value="{{ date('Y-m-d') }}" required 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="title" placeholder="例: オイル交換" required 
                                        class="block w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:border-orange-500 focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 outline-none transition-all">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="cost" placeholder="例: 3000" 
                                        class="block w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:border-orange-500 focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 outline-none transition-all">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 mb-1 ml-1">走行距離 (km) <span class="font-normal text-gray-300">任意</span></label>
                                    <input type="number" name="odometer" placeholder="例: 12345" 
                                        class="block w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:border-orange-500 focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 outline-none transition-all">
                                </div>
                            </div>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-gray-400 mb-1 ml-1">メモ <span class="font-normal text-gray-300">任意</span></label>
                                <textarea name="note" placeholder="詳細メモ" rows="2" 
                                    class="block w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:border-orange-500 focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 outline-none transition-all"></textarea>
                            </div>

<x-layout>
    <x-slot:title>新規ツーリングガイド作成 | MotoHub</x-slot:title>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold">新規ツーリングガイド作成</h1>
        ...
        @if(request('lat') && request('lng'))
            <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm font-medium text-blue-800">ライダーズマップからガイドを作成中です</p>
                    <p class="text-xs text-blue-600 mt-0.5">ツーリングルートの魅力を自由に書いてください。位置情報は自動で設定済みです。</p>
                </div>
            </div>
        @endif
        ...
        <form method="POST" action="{{ route('admin.touring.store') }}" id="guideForm">
            @csrf
            ...
            <div class="mb-6">
                ...
                <div class="editor-container">
                    <div class="editor-pane">
                        <textarea name="body" id="markdownEditor" placeholder="Markdownでツーリングガイドを書く..." required>{{ old('body') }}</textarea>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="difficulty" class="w-full rounded-lg border-gray-300 text-sm" required>
                        <option value="">選択してください</option>
                        <option value="初級" @selected(old('difficulty') === '初級')>初級</option>
                        <option value="中級" @selected(old('difficulty') === '中級')>中級</option>
                        <option value="上級" @selected(old('difficulty') === '上級')>上級</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-600 mb-1">距離（km）</label>
                    <input type="number" name="distance_km" value="{{ old('distance_km') }}" min="0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="duration_text" value="{{ old('duration_text') }}" maxlength="50"
                ...
                <div>
                    ...
                    <input type="text" name="best_season" value="{{ old('best_season') }}" maxlength="100"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" name="zoom_level" value="{{ old('zoom_level', 12) }}" min="1" max="18"
